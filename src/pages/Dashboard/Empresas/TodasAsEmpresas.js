                ...
                {empresas.map(el => (
                  <tr key={el.id}>
                    ...
                    <td>
                      {el.destaque ? (
                        <button
                          title="Tirar o detaque"
                          onClick={() => handleRemoveDestaque(el.id)}
                          className="btn-floating btn-samall waves-effect waves-light green"
                        >
                        ...
                        <button
                          ...
                          onClick={() => handleAddDestaque(el.id)}
                    ...
                    <td>
                      <a href={`/novaEmpresa/${el.id}/files`}>Detalhes</a>
                    </td>
                    <td>
                      <a href={`/editarEmpresa/${el.id}`}>editar</a>
                    </td>
                  </tr>
                ))}
              </tbody>
