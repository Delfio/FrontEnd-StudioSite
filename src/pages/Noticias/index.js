              ...
              <div className="row">
                <DivNoticia className="col s12 l6">
                  <a href={`noticia/${noticia1.id}`}>
                    <TxtNoticiaPrincipal>{noticia1.titulo}</TxtNoticiaPrincipal>
                  </a>
                  {noticia3.map(el => (
                    <section key={el.id} className="col s12 l12">
                      <a href={`noticia/${el.id || null}`}>
                        <TxtNoticiasSecundarias>
                          {el.titulo}
                        </TxtNoticiasSecundarias>
                      </a>
                    ...
                    <a key={el.id} href={`noticia/${el.id}`}>
                      <div className="col s6 l6 m6">
                        ...
                        <section className="">
                          ...
                          <p className="red-text">* {el.brev_descricao}</p>
                        </section>
                      </div>
                    </a>
                  ))}
                    ...
                    {noticia8.map(el => (
                      <a key={el.id} href={`noticia/${el.id}`}>
                        <div className="col s12 l4">
                          ...
                          <section className="col s12">
                            <TituloNoticia>{el.titulo}</TituloNoticia>
                          </section>
                        </div>
                      </a>
                    ))}
