    ...
    <div className="container">
      <Container className="col s12">
        ...
        <Form schema={schema} className="row" onSubmit={handleSubmit}>
          ...
          <div className="input-field col l12 s12">
            <Input name="descricao" id="titulo" type="text" className="materialize-textarea" />
        ...
        <br/>
        <h6> * Antes de tudo, para criar um anúncio classificado eficiente que dá bons resultados de marketing é preciso seguir algumas dicas. Uma delas é incluir, uma boa imagem, chamativa e que dê uma ideia o mais exata possível a respeito da oferta. </h6>
        <h6> * Deixar seu contato é imprescindível para que o interessado entre em contato e possa fazer negócio. </h6>
        <h6> * Todo anúncio classificado deve conter, além da imagem, informações do anúncio, informações de contato e o mais importante… palavras chave. Isso, aliado a um bom serviço de classificados, pode auxiliar sim, qualquer empresa a vender mais e conquistar mais clientes. </h6>
      </Container>
    </div>
  );
}
