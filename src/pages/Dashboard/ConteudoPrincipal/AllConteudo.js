              ...
              <tbody>
                {info1.map(el => (
                  <tr key={el.id}>
                    <td>{el.titulo}</td>
                    <td className="center">
                      {el.empresa ? el.empresa : 'Nulo'}
                    </td>
                    <td className="center">
                      {el.telefone ? el.telefone : 'Nulo'}
                    </td>
                    <td className="center">
                    ...
                    <td>
                      <a href={`/editarConteudoPrincipal/${el.id}`}>Editar</a>
                    </td>
                    <td>
                      <a href={`/newPrincipal/${el.id}/files`}>Conteudos</a>
                    </td>
                    <td>
                      <button
                        className="center btn-floating btn-small waves-effect waves-light red"
                        title="Deletar Conteudo"
