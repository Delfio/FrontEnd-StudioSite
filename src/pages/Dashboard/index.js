            ...
            <>
              <Container className="col s12">
                <li
                  style={{
                    background:
                      'linear-gradient(45deg, rgba(4, 139, 209), rgba(35, 193, 255))',
                  }}
                  className="col m6 l3 s12"
                >
                  ...
                  <div className="col s12 center">
                    <h4 style={{ margin: 0 }} className="white-text bold">
                      15
                    </h4>
                  </div>
                </li>
                ...
                <li
                  style={{
                    background:
                      'linear-gradient(45deg, rgba(255, 86, 88), rgba(245, 138, 169))',
                  }}
                  className="col m6 l3 s12"
                >
                ...
                <li
                  style={{
                    background:
                      'linear-gradient(45deg, rgba(255, 115, 1), rgba(255, 194, 36))',
                  }}
                  className="col m6 l3 s12"
                >
                ...
                <li
                  style={{
                    background: 'linear-gradient(45deg, #41A34C, #20E4AE)',
                  }}
                  className="col m6 l3 s12"
                >
              ...
              <div className="row">
                <div className="col s12 m12 l6">
                  <Ul2 className="card">
                    <li>
                      <i className="medium material-icons blue-text">
                        account_circle
                      </i>
                      <h5>{user.username}</h5>
                    </li>
                    ...
                    <li>
                      ...
                      <h6 className="bold">{user.phone}</h6>
                    </li>
                    <li className="divider" />
                    <li>
                ...
                <div className="col s12 m12 l6">
                  ...
                  <p>
                    Caso tenha algum problema, atualize a página!
                    <br />
