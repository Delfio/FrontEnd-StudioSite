      ...
      <Container className="col s12">
        {autorizado ? (
          <>
            ...
            <h6>
              4. Classifique as publicações como 'Empresa destaque' ou 'Empresa
              Normal'
            </h6>
            <h6>
              5. Empresas em destaque ficam no topo da página e tem mais
              informações expostas
            </h6>
            <h6>
              6. Insira as imagens de acordo com as especificações, depois de
              confirmar os campos a baixo
            </h6>
            <br />
