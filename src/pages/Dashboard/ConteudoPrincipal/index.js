...
const schema = Yup.object().shape({
  titulo: Yup.string().required('Insira um titulo do conteúdo'),
  empresa: Yup.string()
  ...
  telefone: Yup.string().max(11, 'Máximo de 11 digitos'),
  tipo: Yup.number()
    .min(1)
    .max(3)
    .default(2),
      ...
      <Container className="col s12">
        {autorizado ? (
          <>
            ...
            <h6>
              . Categoria 1 se trata do video na página principal principal
            </h6>
            <h6>
              . Categoria 2 se trata dos conteudos ao lado do video na página
              principal
            </h6>
