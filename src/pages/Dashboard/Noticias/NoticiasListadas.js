      ...
      <Container className="col s12">
        {autorizado ? (
          <>
            ...
            <hr />
            <h6>
              . Todas as noticias nesta lista estão listadas na página principal
            </h6>
            <h6>
              . As noticias são classificadas de acordo com a sua classificação
              cadastrada
            </h6>
            <br />
            ...
            <table className="highlight">
              ...
              <tbody>
                ...
                <td>
                  <Link to={`/novaNews/${noticia1.id}/files`}>Visualizar</Link>
                </td>
                <td>
                  <Link to={`editarNews/${noticia1.id}`}>Editar</Link>
                </td>
                <td>
                  <button
                    title="Remover Noticia"
                    onClick={() => DeleteNews(noticia1.id)}
              ...
              <tbody>
                {noticia2.map(el => (
                  <tr key={el.id}>
                    ...
                    <td>
                      <Link to={`/novaNews/${el.id}/files`}>Visualizar</Link>
                    </td>
                    <td>
