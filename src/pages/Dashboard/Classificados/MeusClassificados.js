  ...
  return (
    <div className="container">
      <Container className="col s12">
          ...
          <tbody>
            {classificado.map(el => (
              <tr key={el.id}>
                ...
                <td>
                  <Link to={`editClassificado/${el.id}`}>editar</Link>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <hr />
        <p>
          Caso seu anuncio esteja demorando para ser aceito, Favor Verifique se
          o mesmo não contém alguma informação errada.
        </p>
      </Container>
    </div>
  );
