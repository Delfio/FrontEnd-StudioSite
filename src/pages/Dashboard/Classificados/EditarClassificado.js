  ...
  return (
    <div className="container">
      <Container className="col s12">
        ...
        <Form schema={schema} onSubmit={handleUpdate} initialData={classificado} className="row">
          ...
          <div className="col s12">
            <button className="btn waves-effect blue-light" type="submit" name="action">Confirmar
              ...
              imagens.map(el => (
                <li key={el.id} className="col s6 l4">
                  ...
                  <section className="col s12">
                    <button className="right" title="Deletar Imagem" onClick={() => handleDeleteImage(el.id)}>
