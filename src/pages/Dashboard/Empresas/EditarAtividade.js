...
export default function EditarAtividade(props) {
  ...
  async function handleSubmit(data){
    const response = await api.put(`empresas/${id}/servico/${atividade_id}`, data);
  ...
  return (
    <div className="container">
      ...
      <Form onSubmit={handleSubmit} initialData={atividade} schema={schema} className="row">
