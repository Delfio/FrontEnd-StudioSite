  ...
  return (
    <div className="container">
      <Container className="col s12">
        ...
        <br />
        <h6>
          * Esta é uma preview de como o classificado vai ficar na página
          principal
        </h6>
        <br />
        <div className="row">
          <>
                ...
                <ul className="slides ">
                  {img1 ? (
                    <>
                      ...
                      <li>
                        <img
                          style={{ minWidth: 250, maxHeight: 450 }}
                          className="responsive-img"
                          src={img2.url}
                        />
                      </li>
            ...
            <div className="col s12 l12">
              ...
              <div className="col s12">
                <p style={{ marginTop: -25 }} className="grey-text">
                  {data}
                </p>
              </div>
              ...
              <div className="row">
                ...
                >
                  ...
                  <a href={`tel:${classificado.fone_contato}`}>
                    <p title="Ligar para o vendedor" style={{ marginLeft: 10 }}>
